Feature: User login in secret santa website
  ...
  Scenario: user logs in uccessfuly
    ...
    When user1 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user2 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user3 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user4 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user5 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user6 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user7 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user8 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user9 logins in "<login>" and "<password>" 
  ...
  Scenario: user logs in uccessfuly
    ...
    When user10 logins in "<login>" and "<password>" 
